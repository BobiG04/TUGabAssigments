...
| Въведение в програмирането | Обектно ориентирано програмиране (C#) | Компютърна графика | Програмиране в интернет среда (Java, HTML, CSS, JavaScript) | Алгоритми и структури от данни | Програмиране на програмни интерфейси | Информационни системи
| :-------------: | :-------------: | :-----: | :-----: |
